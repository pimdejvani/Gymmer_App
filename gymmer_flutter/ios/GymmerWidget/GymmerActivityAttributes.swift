...
// update it while the app is backgrounded. The ContentState carries only what the
// Lock Screen renders — the interactive buttons mutate session.json directly, not
// this state.
@available(iOS 16.1, *)
