...
| File | Contents |
|---|---|
| `ios/GymmerWidget/GymmerWidget.swift` | iOS 17 medium widget and Live Activity pages, shared JSON store/mutations, ordinary home-widget intents, rest notification, and Runner-side Activity intent wrapper |
